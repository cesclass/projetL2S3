...
int ** creer_mat_int(int nbRows, int nbCols); // malob 2D (malloc maybe...)
void affiche_tab_int(int *tab, int dim, FILE *logfp);

void creer_t_mat_int_dyn(t_mat_int_dyn *stTab, int nbRows, int nbCols); // utilise la struct
...
void init_mat_int(int **mat, int nbRows, int nbCols, int valeur); // idem
